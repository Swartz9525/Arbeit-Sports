    ...
    <div className="flex justify-center items-center py-16">
      <div className="w-full max-w-md p-8 glass-panel border border-white/10 rounded-2xl shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-3xl font-black tracking-tight text-white uppercase">SIGN IN</h2>
          <p className="text-zinc-400 text-xs font-semibold">WELCOME BACK TO ARBEIT SPORTS</p>
        </div>
        ...
        <div className="text-center text-xs text-zinc-400 font-semibold pt-2 space-y-2">
          <div>
            New athlete?{' '}
          ...
          <div className="pt-2 border-t border-white/5 text-zinc-500 text-[11px]">
            Are you an Administrator?{' '}
            <Link to="/admin/login" className="text-violet-400 hover:underline font-bold">
              Access Admin Portal
            </Link>
          </div>
        </div>
